# Milkdrop Web: mic-driven, beat-aware music visualizer for TVs and projectors — no audio routing (`milkdrop-web`) — factory product contract

This repository is one product built by the Param Factory. It ships at
`https://milkdrop-web.sociobot.in`. Artifact class: `static-web`.
