...
await writeFile(secondIndex, (await readFile(secondIndex, 'utf8')).replace('Built by Param Factory · v1.1.1', 'Built by Param Factory · v1.1.2'));
...
try {
  ...
  await page.waitForFunction(() => document.body.textContent?.includes('Built by Param Factory · v1.1.2'), undefined, { timeout: 10_000 });
